...
//    cout << "posa0" << "   " << "posa1" << "    " << "posb0" << "    " << "posb1" << endl;
...
//    cout << "aForwards" << "     " << "bForwards" << endl;
//    cout << aForwards << "     " << bForwards << endl;

    if(aForwards){
//        cout << "A" << endl;
        for(int i=0; i<nodes.n-1; ++i) {
//            cout << (posa0+i)%nodes.n << endl;
            ring.addNode(nodes[(posa0+i)%nodes.n]);
        }
    }
    else{
//        cout << "B" << endl;
        for(int i=0; i<nodes.n-1; ++i) {
//            cout << (posa0+nodes.n-i)%nodes.n << endl;
            ring.addNode(nodes[(posa0+nodes.n-i)%nodes.n]);
        }
    }
    ...
    if(bForwards){
//        cout << "C" << endl;
        for(int i=0; i<other.nodes.n-1; ++i) {
//            cout << (posb1+i)%other.nodes.n << endl;
            ring.addNode(other.nodes[(posb1+i)%other.nodes.n]);
        }
    }
    else{
//        cout << "D" << endl;
        for(int i=0; i<other.nodes.n-1; ++i) {
//            cout << (posb1+other.nodes.n-i)%other.nodes.n << endl;
            ring.addNode(other.nodes[(posb1+other.nodes.n-i)%other.nodes.n]);
        }
    }
